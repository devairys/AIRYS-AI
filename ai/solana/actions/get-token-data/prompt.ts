...
If a user asks for the native token of AIRYS AI, this platform, call this function with the contract address of the native token: 9DHe3pycTuymFk4H4bbPoAJ4hQrr2kaLDF6J6aAKpump.`;